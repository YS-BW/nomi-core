...
from nomi.agent.execution.messages import build_assistant_message, find_legal_message_start
...
from nomi.providers.base import LLMProvider, ToolCallRequest
from nomi.utils.runtime import (
...
from nomi.utils.text import truncate_text
...
class AgentRunner:
    ...
    async def _emit_tool_status(
        ...
        *,
        ...
        callback = spec.tool_status_callback
        if callback is not None:
            await callback(
                tool_call=tool_call,
                status=status,
