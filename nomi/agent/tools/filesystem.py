...
from nomi.agent.tools.schema import (
    BooleanSchema,
    IntegerSchema,
    StringSchema,
...
class ReadFileTool(_FsTool):
    ...
    async def execute(self, path: str | None = None, offset: int = 1, limit: int | None = None, pages: str | None = None) -> Any:
        """执行文件读取。
...
class WriteFileTool(_FsTool):
    ...
    async def execute(self, path: str | None = None, content: str | None = None) -> str:
        """执行整文件写入。
